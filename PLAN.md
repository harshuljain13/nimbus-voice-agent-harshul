...
| 3 | RAG retrieval | chunk · embed · FAISS · top-k | ▶ next |
| 4 | RAG vs RAGless | toggle + rerank + 2D vector/query viz | ◻ |
| 5 | LLM controls | Gemini, history (verbatim-N + summary), RAG routing | ◻ |
| 6 | Streaming vs batch | TTFT vs total | ◻ |
| 7 | Tools | 11 cart/pricing tools + on/off selection | ◻ |
...
| 12 | Widget + deploy | landing chatbox + Vercel/Railway | ◻ |
